...
$L_R, L_{R,p} \geq 0$ & Lipschitz constants of $R$ in $\rho$ and $\nabla_p R$ \\
$\rho_{\min}, \rho_{\max}$ & lower/upper density bounds (non-vacuum condition) \\
$\kappa = \eps L_R/\lambda$ & contraction rate of the outer iteration \\
...
Existence and uniqueness under monotonicity conditions on $f_0$ and $g$
are established in \citet{lasry2007mean}.
...
Ours (Extended-MFGAN) & Weak & Distributional & Wasserstein-2 & Explicit \\
\bottomrule
\end{tabular}
...
non-separable Hamiltonians and retains distributional learning with
Wasserstein convergence guarantees. Our method occupies this gap.
