...
Because the densities are bounded, $L^2$ convergence at rate kappa-to-the-k
implies Wasserstein-2 convergence at rate kappa-to-the-k-over-two. The
square-root scaling comes from the standard $L^1$-to-Wasserstein-2
inequality. We still get a strict improvement over MFDGM, which only gets
$L^p$ for $p$ less than two and provides no rate at all.
